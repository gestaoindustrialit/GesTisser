...
$detectExtensionMethod = new ReflectionMethod(ShopfloorAttachment::class, 'detectExtension');
if ($detectExtensionMethod->hasReturnType()) {
    throw new RuntimeException('detectExtension deve manter uma assinatura compatível com PHP 7.0.');
}
