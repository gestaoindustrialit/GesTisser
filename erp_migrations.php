...
function erp_run_phase1_migrations(PDO $pdo)
{
    ...
    try {
        ...
        $operationColumns=['description'=>'TEXT','operation_type'=>'TEXT NOT NULL DEFAULT "production"','default_instructions'=>'TEXT','setup_minutes'=>'REAL NOT NULL DEFAULT 0','time_per_unit'=>'REAL NOT NULL DEFAULT 0','time_unit'=>'TEXT NOT NULL DEFAULT "minutes"','production_unit'=>'TEXT NOT NULL DEFAULT "unit"','min_operators'=>'INTEGER NOT NULL DEFAULT 1','requires_good_quantity'=>'INTEGER NOT NULL DEFAULT 1','requires_waste'=>'INTEGER NOT NULL DEFAULT 1','requires_waste_reason'=>'INTEGER NOT NULL DEFAULT 1','requires_quality'=>'INTEGER NOT NULL DEFAULT 0','notes'=>'TEXT','created_by'=>'INTEGER REFERENCES users(id) ON DELETE SET NULL','updated_by'=>'INTEGER REFERENCES users(id) ON DELETE SET NULL','created_at'=>'DATETIME DEFAULT CURRENT_TIMESTAMP','updated_at'=>'DATETIME DEFAULT CURRENT_TIMESTAMP'];
