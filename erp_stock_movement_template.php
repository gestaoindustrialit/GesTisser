...
require_login();gt_erp_run_phase1_migrations($pdo);$user=current_user($pdo)?:[];
if(!gt_erp_user_can($pdo,$user,'erp.stock_adjust')){http_response_code(403);exit('Sem permissão.');}
