...
<div class="bi-dashboard" id="biDashboard" data-refresh="<?= (int)($initial['settings']['bi_tv_refresh_seconds']??300) ?>" data-rotate="<?= (int)($initial['settings']['bi_tv_rotate_seconds']??30) ?>">
  ...
  <section class="bi-tv-slide" data-bi-slide><div class="bi-section-title"><span>1</span><div><small>Cards principais</small><h3>Execução da produção</h3></div></div><div class="bi-kpis" data-bi-kpis-primary></div></section>
  <section class="bi-tv-slide" data-bi-slide><div class="bi-section-title"><span>2</span><div><small>Cards principais</small><h3>Desvios e controlo</h3></div></div><div class="bi-kpis" data-bi-kpis-control></div></section>
  <section class="bi-tv-slide" data-bi-slide><div class="bi-grid bi-charts-grid"><article class="bi-panel"><header><div><small>Produção</small><h3>Planeada vs. realizada</h3></div></header><div class="bi-chart"><canvas id="chartPlan"></canvas></div></article><article class="bi-panel"><header><div><small>Tempos</small><h3>Horas trabalhadas, produtivas e de máquina</h3></div></header><div class="bi-chart"><canvas id="chartHours"></canvas></div></article><article class="bi-panel"><header><div><small>Máquinas</small><h3>Utilização por máquina</h3></div></header><div class="bi-chart"><canvas id="chartMachines"></canvas></div></article><article class="bi-panel"><header><div><small>Desperdício</small><h3>Por máquina/operação</h3></div></header><div class="bi-chart"><canvas id="chartWaste"></canvas></div></article><article class="bi-panel"><header><div><small>Paragens</small><h3>Principais causas</h3></div></header><div class="bi-chart"><canvas id="chartStops"></canvas></div></article><article class="bi-panel"><header><div><small>Fluxo operacional</small><h3>OF por estado</h3></div></header><div class="bi-chart"><canvas id="chartStatus"></canvas></div></article></div></section>
