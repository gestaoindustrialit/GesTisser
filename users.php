        ...
        if ($name === '' || $username === '' || $email === '' || $password === '') {
            ...
            try {
                ...
                $stmt->execute([
                    ...
                    $notes,
                    $sendAccessEmail,
                    $taxNumber, $socialSecurityNumber, $address, $postalCode, $parish,
