...
final class InventoryService
{
    ...
    public static function rows(PDO $pdo,array $filters): array
    {
        ...
        if($filters['color']!==''){$sql.=' AND inventory.color LIKE ?';$params[]='%'.$filters['color'].'%';}
