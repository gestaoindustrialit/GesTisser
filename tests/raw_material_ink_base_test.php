...
ink_base_check(strpos($erp, 'Configurar tipos e ícones') === false, 'O editor não deve apresentar um atalho para configurar tipos e ícones.');
...
ink_base_check(gt_erp_migration_table_exists($pdo, 'erp_ink_types'), 'A migração isolada não criou a tabela de tipos de tinta.');
ink_base_check(gt_erp_migration_column_exists($pdo, 'erp_raw_materials', 'ink_type_id'), 'A migração isolada não adicionou a associação à matéria-prima.');
