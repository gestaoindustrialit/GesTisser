<?php
$files=['GenericPdfOrderParser.php','OrderImportMatcher.php','OrderImportNormalizer.php','OrderPdfUpload.php','PdfTextExtractor.php','PurchaseOrderImportService.php','SupplierSpecificParserInterface.php'];
