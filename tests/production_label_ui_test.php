...
production_label_check(strpos($label,'@page{size:100mm 50mm;margin:0}')!==false,'etiqueta não está configurada para 10 cm por 5 cm');
production_label_check(strpos($label,"app_setting(\$pdo,'logo_report_dark'")!==false,'etiqueta não usa o logótipo configurado para relatórios');
production_label_check(strpos($label,'class="brand-fallback"')!==false,'etiqueta não apresenta identificação da empresa sem logótipo configurado');
